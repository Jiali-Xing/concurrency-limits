...
public class GrpcServerCharonBuilder extends CharonLimiter.Builder<GrpcServerCharonBuilder, GrpcServerRequestContext> {
    /**
     * Partition the limit by method
     * @return Chainable builder
     */
    public GrpcServerCharonBuilder partitionByMethod() {
     ...
     * @return Chainable builder
     */
    public GrpcServerCharonBuilder partitionByHeader(Metadata.Key<String> header) {
     ...
     * @return Chainable builder
     */
    public GrpcServerCharonBuilder partitionByAttribute(Attributes.Key<String> attribute) {
        return partitionResolver(context -> context.getCall().getAttributes().get(attribute));
    }

    @Override
    protected GrpcServerCharonBuilder self() {
        return this;
    }
}
