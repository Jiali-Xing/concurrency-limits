 ...
 */
public class CharonConcurrencyLimitClientInterceptor implements ClientInterceptor {
    ...
    public CharonConcurrencyLimitClientInterceptor(final Limiter<GrpcClientRequestContext> grpcLimiter) {
                            ...
                            public void start(final Listener<RespT> responseListener, final Metadata headers) {
                                super.start(new ForwardingClientCallListener.SimpleForwardingClientCallListener<RespT>(responseListener) {
                                    ...
                                    public void onHeaders(Metadata headers) {
                                        // Read response header on the client side, the price table 
                                        System.out.println("Metadata on the Client listener side: " + headers.get(Metadata.Key.of("price", Metadata.ASCII_STRING_MARSHALLER)));
                                    }
                                }, headers);
                            }
