...
public class ConcurrencyLimitServerInterceptor implements ServerInterceptor {
    ...
    public static final Metadata.Key<String> ID_HEADER = Metadata.Key.of("price", Metadata.ASCII_STRING_MARSHALLER);
                        ...
                        delegate = next.startCall(
                                new ForwardingServerCall.SimpleForwardingServerCall<ReqT, RespT>(call) {
                                    ...
                                    public void sendHeaders(Metadata headers) {
                                        // Change header on the server side, add price table 
                                        int price = 1314;
                                        headers.put(ID_HEADER, String.valueOf(price));
                                        System.out.println("Metadata on the Server listener side: " + headers.get(Metadata.Key.of("price", Metadata.ASCII_STRING_MARSHALLER)));
